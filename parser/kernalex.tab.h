...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TOK_LBRACE = 73,               /* TOK_LBRACE  */
    TOK_RBRACE = 74,               /* TOK_RBRACE  */
...
union YYSTYPE
{
#line 104 "parser/kernalex.y"

	int val;
	struct symtab *symp;

#line 152 "parser/kernalex.tab.h"
