...
OUT_FILE="parser/part3_tests/all_table_outputs.txt"
: > "$OUT_FILE"

echo "=== PART 1: OUTPUT FORMAT TESTS ==="

total=0
ok=0

# Loop through all .kl files in the part3_tests directory
for f in parser/part3_tests/*.kl; do
